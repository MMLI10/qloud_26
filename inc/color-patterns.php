 ...
 */
function qloud_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter qloud default saturation level.
	 *
	 * @since qloud 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'qloud_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.qloud-front-page) .entry-title,
...
.colors-custom .qloud-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.qloud-front-page .panel-content .recent-posts article,
...
.colors-custom.qloud-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters qloud custom colors CSS.
	 *
	 * @since qloud 1.0
	 *
	 ...
	 */
	return apply_filters( 'qloud_custom_colors_css', $css, $hue, $saturation );
}
