...
$options = '';
if(isset($qloud_options['qloud_blog'])) {
    $options = $qloud_options['qloud_blog'];
}
$sidebar = '';
if(isset($qloud_options['qloud_blog_sidebar'])) {
	$sidebar = $qloud_options['qloud_blog_sidebar'];
} ?>
		...
		<div class="row flex-row-reverse">
			<div class="col-sm-12">
				<div class="heading-title white iq-breadcrumb-title">
					<h1 class="title"><?php  esc_html_e( 'Home', 'qloud' ); ?></h1>
				</div>
			</div>
		</div>
	</div>
				...
				if($options == 1)
				 {
					...
					<div class="<?php echo esc_attr($row); ?>">
						...
						<?php } ?>
							...
							?>
							<?php
							if(isset($qloud_option['qloud_display_pagination']))
							{
							$options = $qloud_option['qloud_display_pagination'];
							if($options == "yes")
							{
							qloud_pagination();
							}
					...
					<div class="<?php echo esc_attr($row); ?>">
						...
						<?php } ?>
							...
							if ( have_posts() ) {
								...
								while ( have_posts() ) : the_post();
								?>
								<div class="col-lg-6 col-md-6 col-sm-6 qloud-space-bottom"> 
								<?php
									/*
									* Include the Post-Format-specific template for the content.
									* If you want to override this in a child theme, then include a file
